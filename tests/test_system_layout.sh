...
assert_contains 'readonly EXIT_CODES_MODULE="${LIB_DIR}/exit_codes.sh"'
...
assert_contains 'readonly AUR_USER_MODULE="${LIB_DIR}/aur_user.sh"'
assert_contains 'readonly AUR_HELPER_MODULE="${LIB_DIR}/aur_helper.sh"'
assert_contains 'readonly AUR_UPDATES_MODULE="${LIB_DIR}/aur_updates.sh"'
assert_contains 'readonly AUR_CONTEXT_MODULE="${LIB_DIR}/aur_context.sh"'
assert_contains 'readonly AUR_PHASE_MODULE="${LIB_DIR}/aur_phase.sh"'
